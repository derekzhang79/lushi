...
public class Effect 
{
	...
	{
		code=ParserHelper.clearBlanks(code);
		...
		if(code.startsWith("union"))
		{
			...
			List<String> params=ParserHelper.extractParams(code.substring(6,code.length()-1));
		...
		{
			this.type="guardadd";
			List<String> params=ParserHelper.extractParams(code.substring(9,code.length()-1));
		...
		{
			this.type="attackadd";
			List<String> params=ParserHelper.extractParams(code.substring(10,code.length()-1));
		...
		{
			this.type="damage";
			List<String> params=ParserHelper.extractParams(code.substring(7,code.length()-1));
		...
		{
			this.type="cure";
			List<String> params=ParserHelper.extractParams(code.substring(5,code.length()-1));
		...
		if(code.startsWith("randomcall"))
		{
			...
			List<String> params=ParserHelper.extractParams(code.substring(11,code.length()-1));
		...
		if(code.startsWith("castdamageadd"))
		{
			...
			List<String> params=ParserHelper.extractParams(code.substring(14,code.length()-1));
